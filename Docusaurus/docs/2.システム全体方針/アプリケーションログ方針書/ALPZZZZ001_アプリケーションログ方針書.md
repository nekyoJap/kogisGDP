...
| ログライブラリ | SLF4J + Logback | - | 構造化ログ出力 |
| 分散トレーシング | OpenTelemetry | - | 導入検討中 |
...
| APIガバナンス方針書 | エラーレスポンス・トレースID標準を参照 |
| トランザクション方針書 | トランザクション境界・ログ出力タイミングを参照 |
