...
以下の【形式】および【ISO/IEC Directives Part 2準拠ルール】に基づいて、対象システムの**「認証・認可方針書」（Identity & Access）を作成してください。\
